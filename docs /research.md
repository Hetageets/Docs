...
## Ընդհանուր ակնարկ
Այս փաստաթուղթը ամփոփում է GPS-ով իրական ժամանակում հետևման համակարգի կառուցման հետ կապված հետազոտությունը՝ LoRa և BLE օգտագործելով։ Հայտնի է, որ համակարգը պետք է կարողանա հավաքել տեղորոշման տվյալներ և փոխանցել դրանք արդյունավետ կերպով երկար հեռավորությունների վրա։

## Համակարգի բաղադրիչներ
### 1. **GPS ընդունիչ**
- Ապրանքներ՝
  - Նվիրված GPS մոդուլ (օրինակ՝ NEO-6M, u-blox մոդուլներ)
  - Միկրոհրաբեր՝ ինտեգրված GPS (օրինակ՝ LilyGO T-Beam)
  - Բջջային հեռախոս՝ GPS (ապպակային հետևում)
  
### 2. **Տվյալների փոխանցման տեխնոլոգիաներ**
