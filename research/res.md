...
Ստորեւ ներկայացուած նկարում ցուցդրուած է իրական չափումների արդիւնքում[\[3\]](#յղումներ) ստացուած տուեալների գրափիկ, որում համեմատուում է neo-6M ընդունիչի եւ քարտեզում իրական կոորդինատների շեղումը եւ նոյն ընդունիչի եւ հեռախոսի GPS֊ի տրուած կոորդինատների համեմատութիւնը։ Կարելի է եզրակացնել, որ չափումների հիմնական մասում neo-6M֊ը տալիս է աւելի քիչ շեղում իրական կոորդինատներից։՛
